...
*/
export class TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen {
    /**
    ...
    */
    'object': TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen.attributeTypeMap;
    }
}

export namespace TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen {
