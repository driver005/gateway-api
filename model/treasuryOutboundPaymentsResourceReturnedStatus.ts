...
* 
*/
export class TreasuryOutboundPaymentsResourceReturnedStatus {
    /**
    * Reason for the return.
    */
    'code': TreasuryOutboundPaymentsResourceReturnedStatus.CodeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "code",
            "baseName": "code",
            "type": "TreasuryOutboundPaymentsResourceReturnedStatus.CodeEnum"
        },
        {
            "name": "transaction",
    ...
    static getAttributeTypeMap() {
        return TreasuryOutboundPaymentsResourceReturnedStatus.attributeTypeMap;
    }
}

export namespace TreasuryOutboundPaymentsResourceReturnedStatus {
