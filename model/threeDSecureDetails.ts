...
* 
*/
export class ThreeDSecureDetails {
    /**
    * For authenticated transactions: how the customer was authenticated by the issuing bank.
    */
    'authenticationFlow': ThreeDSecureDetails.AuthenticationFlowEnum;
    /**
    * Indicates the outcome of 3D Secure authentication.
    */
    'result': ThreeDSecureDetails.ResultEnum;
    /**
    * Additional information about why 3D Secure succeeded or failed based on the `result`.
    */
    'resultReason': ThreeDSecureDetails.ResultReasonEnum;
    /**
    * The version of 3D Secure that was used.
    */
    'version': ThreeDSecureDetails.VersionEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "ThreeDSecureDetails.AuthenticationFlowEnum"
        },
        {
            "name": "result",
            "baseName": "result",
            "type": "ThreeDSecureDetails.ResultEnum"
        },
        {
            "name": "resultReason",
            "baseName": "result_reason",
            "type": "ThreeDSecureDetails.ResultReasonEnum"
        },
        {
            "name": "version",
            "baseName": "version",
            "type": "ThreeDSecureDetails.VersionEnum"
        }    ];

    static getAttributeTypeMap() {
        return ThreeDSecureDetails.attributeTypeMap;
    }
}
