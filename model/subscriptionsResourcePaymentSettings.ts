...
* 
*/
export class SubscriptionsResourcePaymentSettings {
    ...
    */
    'paymentMethodTypes': Array<SubscriptionsResourcePaymentSettings.PaymentMethodTypesEnum>;
    /**
    ...
    */
    'saveDefaultPaymentMethod': SubscriptionsResourcePaymentSettings.SaveDefaultPaymentMethodEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "Array<SubscriptionsResourcePaymentSettings.PaymentMethodTypesEnum>"
        },
        {
            "name": "saveDefaultPaymentMethod",
            "baseName": "save_default_payment_method",
            "type": "SubscriptionsResourcePaymentSettings.SaveDefaultPaymentMethodEnum"
        }    ];

    static getAttributeTypeMap() {
        return SubscriptionsResourcePaymentSettings.attributeTypeMap;
    }
}
