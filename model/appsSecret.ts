...
export class AppsSecret {
    ...
    */
    ...
    static getAttributeTypeMap() {
        return AppsSecret.attributeTypeMap;
    }
}

export namespace AppsSecret {
    export enum ObjectEnum {
        AppsSecret = <any> 'apps.secret'
    }
}
