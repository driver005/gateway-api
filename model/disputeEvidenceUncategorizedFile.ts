...
*/
export class DisputeEvidenceUncategorizedFile {
    /**
    ...
    */
    'object': DisputeEvidenceUncategorizedFile.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': DisputeEvidenceUncategorizedFile.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "DisputeEvidenceUncategorizedFile.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "DisputeEvidenceUncategorizedFile.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return DisputeEvidenceUncategorizedFile.attributeTypeMap;
    }
}

export namespace DisputeEvidenceUncategorizedFile {
