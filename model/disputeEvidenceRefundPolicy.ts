...
*/
export class DisputeEvidenceRefundPolicy {
    /**
    ...
    */
    'object': DisputeEvidenceRefundPolicy.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': DisputeEvidenceRefundPolicy.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "DisputeEvidenceRefundPolicy.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "DisputeEvidenceRefundPolicy.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return DisputeEvidenceRefundPolicy.attributeTypeMap;
    }
}

export namespace DisputeEvidenceRefundPolicy {
