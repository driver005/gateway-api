...
export class PriceRecurring {
    ...
    */
    'aggregateUsage': PriceRecurring.AggregateUsageEnum;
    /**
    * The frequency at which a subscription is billed. One of `day`, `week`, `month` or `year`.
    */
    'interval': PriceRecurring.IntervalEnum;
    /**
    ...
    */
    'usageType': PriceRecurring.UsageTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "PriceRecurring.AggregateUsageEnum"
        },
        {
            "name": "interval",
            "baseName": "interval",
            "type": "PriceRecurring.IntervalEnum"
        },
        {
            "name": "intervalCount",
        ...
        },
        {
            "name": "usageType",
            "baseName": "usage_type",
            "type": "PriceRecurring.UsageTypeEnum"
        }    ];
