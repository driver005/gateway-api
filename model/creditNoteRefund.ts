...
export class CreditNoteRefund {
    ...
    */
    'object': CreditNoteRefund.ObjectEnum;
    'paymentIntent': RefundPaymentIntent | null;
    /**
    * Reason for the refund, either user-provided (`duplicate`, `fraudulent`, or `requested_by_customer`) or generated by Stripe internally (`expired_uncaptured_charge`).
    */
    'reason': CreditNoteRefund.ReasonEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "CreditNoteRefund.ObjectEnum"
        },
        {
            "name": "paymentIntent",
        ...
        },
        {
            "name": "reason",
            "baseName": "reason",
            "type": "CreditNoteRefund.ReasonEnum"
        },
        {
            "name": "receiptNumber",
    ...
    static getAttributeTypeMap() {
        return CreditNoteRefund.attributeTypeMap;
    }
}

export namespace CreditNoteRefund {
