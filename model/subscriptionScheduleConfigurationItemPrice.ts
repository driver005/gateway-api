...
*/
export class SubscriptionScheduleConfigurationItemPrice {
    /**
    ...
    */
    'billingScheme': SubscriptionScheduleConfigurationItemPrice.BillingSchemeEnum;
    /**
    ...
    */
    'object': SubscriptionScheduleConfigurationItemPrice.ObjectEnum;
    'product': PriceProduct;
    'recurring': PriceRecurring | null;
    /**
    * Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
    */
    'taxBehavior': SubscriptionScheduleConfigurationItemPrice.TaxBehaviorEnum;
    /**
    ...
    */
    'tiersMode': SubscriptionScheduleConfigurationItemPrice.TiersModeEnum;
    'transformQuantity': PriceTransformQuantity | null;
    /**
    * One of `one_time` or `recurring` depending on whether the price is for a one-time purchase or a recurring (subscription) purchase.
    */
    'type': SubscriptionScheduleConfigurationItemPrice.TypeEnum;
    /**
    ...
    */
    'deleted': SubscriptionScheduleConfigurationItemPrice.DeletedEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SubscriptionScheduleConfigurationItemPrice.BillingSchemeEnum"
        },
        {
            "name": "created",
            "baseName": "created",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "SubscriptionScheduleConfigurationItemPrice.ObjectEnum"
        },
        {
            "name": "product",
            "baseName": "product",
        ...
        },
        {
            ...
            "type": "SubscriptionScheduleConfigurationItemPrice.TaxBehaviorEnum"
        },
        {
            "name": "tiers",
            "baseName": "tiers",
        ...
        },
        {
            "name": "tiersMode",
            "baseName": "tiers_mode",
            "type": "SubscriptionScheduleConfigurationItemPrice.TiersModeEnum"
        },
        {
        ...
        },
        {
            "name": "deleted",
            "baseName": "deleted",
            "type": "SubscriptionScheduleConfigurationItemPrice.DeletedEnum"
        }    ];

    static getAttributeTypeMap() {
        return SubscriptionScheduleConfigurationItemPrice.attributeTypeMap;
    }
}

export namespace SubscriptionScheduleConfigurationItemPrice {
