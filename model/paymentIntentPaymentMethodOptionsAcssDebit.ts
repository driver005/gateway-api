...
* 
*/
export class PaymentIntentPaymentMethodOptionsAcssDebit {
    ...
    */
    'setupFutureUsage'?: PaymentIntentPaymentMethodOptionsAcssDebit.SetupFutureUsageEnum;
    /**
    * Bank account verification method.
    */
    'verificationMethod'?: PaymentIntentPaymentMethodOptionsAcssDebit.VerificationMethodEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "PaymentIntentPaymentMethodOptionsAcssDebit.SetupFutureUsageEnum"
        },
        {
            "name": "verificationMethod",
            "baseName": "verification_method",
            "type": "PaymentIntentPaymentMethodOptionsAcssDebit.VerificationMethodEnum"
        }    ];

    static getAttributeTypeMap() {
        return PaymentIntentPaymentMethodOptionsAcssDebit.attributeTypeMap;
    }
}
