...
* 
*/
export class PaymentPagesCheckoutSessionCustomerDetails {
    ...
    */
    'taxExempt': PaymentPagesCheckoutSessionCustomerDetails.TaxExemptEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "taxExempt",
            "baseName": "tax_exempt",
            "type": "PaymentPagesCheckoutSessionCustomerDetails.TaxExemptEnum"
        },
        {
            "name": "taxIds",
            "baseName": "tax_ids",
    ...
    static getAttributeTypeMap() {
        return PaymentPagesCheckoutSessionCustomerDetails.attributeTypeMap;
    }
}
