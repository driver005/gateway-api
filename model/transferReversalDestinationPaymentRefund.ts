...
*/
export class TransferReversalDestinationPaymentRefund {
    /**
    * Amount, in %s.
    */
    'amount': number;
    ...
    */
    'object': TransferReversalDestinationPaymentRefund.ObjectEnum;
    'paymentIntent': RefundPaymentIntent | null;
    /**
    * Reason for the refund, either user-provided (`duplicate`, `fraudulent`, or `requested_by_customer`) or generated by Stripe internally (`expired_uncaptured_charge`).
    */
    'reason': TransferReversalDestinationPaymentRefund.ReasonEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "TransferReversalDestinationPaymentRefund.ObjectEnum"
        },
        {
            "name": "paymentIntent",
        ...
        },
        {
            "name": "reason",
            "baseName": "reason",
            "type": "TransferReversalDestinationPaymentRefund.ReasonEnum"
        },
        {
            "name": "receiptNumber",
    ...
    static getAttributeTypeMap() {
        return TransferReversalDestinationPaymentRefund.attributeTypeMap;
    }
}

export namespace TransferReversalDestinationPaymentRefund {
