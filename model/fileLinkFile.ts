...
export class FileLinkFile {
    ...
    */
    'object': FileLinkFile.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': FileLinkFile.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "FileLinkFile.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "FileLinkFile.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return FileLinkFile.attributeTypeMap;
    }
}

export namespace FileLinkFile {
