...
*/
export class DisputeEvidenceCancellationPolicy {
    /**
    ...
    */
    'object': DisputeEvidenceCancellationPolicy.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': DisputeEvidenceCancellationPolicy.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "DisputeEvidenceCancellationPolicy.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "DisputeEvidenceCancellationPolicy.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return DisputeEvidenceCancellationPolicy.attributeTypeMap;
    }
}

export namespace DisputeEvidenceCancellationPolicy {
