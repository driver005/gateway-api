...
* 
*/
export class InvoicePaymentMethodOptionsUsBankAccount {
    'financialConnections'?: InvoicePaymentMethodOptionsUsBankAccountLinkedAccountOptions;
    /**
    * Bank account verification method.
    */
    'verificationMethod'?: InvoicePaymentMethodOptionsUsBankAccount.VerificationMethodEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "InvoicePaymentMethodOptionsUsBankAccount.VerificationMethodEnum"
        }    ];

    static getAttributeTypeMap() {
        return InvoicePaymentMethodOptionsUsBankAccount.attributeTypeMap;
    }
}
