...
* 
*/
export class PaymentMethodDetailsInteracPresentReceipt {
    /**
    * The type of account being debited or credited
    */
    'accountType'?: PaymentMethodDetailsInteracPresentReceipt.AccountTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "PaymentMethodDetailsInteracPresentReceipt.AccountTypeEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return PaymentMethodDetailsInteracPresentReceipt.attributeTypeMap;
    }
}
