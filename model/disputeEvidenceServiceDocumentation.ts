...
*/
export class DisputeEvidenceServiceDocumentation {
    /**
    ...
    */
    'object': DisputeEvidenceServiceDocumentation.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': DisputeEvidenceServiceDocumentation.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "DisputeEvidenceServiceDocumentation.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "DisputeEvidenceServiceDocumentation.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return DisputeEvidenceServiceDocumentation.attributeTypeMap;
    }
}

export namespace DisputeEvidenceServiceDocumentation {
