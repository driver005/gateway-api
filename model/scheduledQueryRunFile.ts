...
*/
export class ScheduledQueryRunFile {
    /**
    ...
    */
    'object': ScheduledQueryRunFile.ObjectEnum;
    /**
    * The [purpose](https://stripe.com/docs/file-upload#uploading-a-file) of the uploaded file.
    */
    'purpose': ScheduledQueryRunFile.PurposeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "ScheduledQueryRunFile.ObjectEnum"
        },
        {
            "name": "purpose",
            "baseName": "purpose",
            "type": "ScheduledQueryRunFile.PurposeEnum"
        },
        {
            "name": "size",
            "baseName": "size",
    ...
    static getAttributeTypeMap() {
        return ScheduledQueryRunFile.attributeTypeMap;
    }
}

export namespace ScheduledQueryRunFile {
