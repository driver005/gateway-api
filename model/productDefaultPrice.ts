...
export class ProductDefaultPrice {
    ...
    */
    'billingScheme': ProductDefaultPrice.BillingSchemeEnum;
    /**
    ...
    */
    'object': ProductDefaultPrice.ObjectEnum;
    'product': PriceProduct;
    'recurring': PriceRecurring | null;
    /**
    * Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
    */
    'taxBehavior': ProductDefaultPrice.TaxBehaviorEnum;
    /**
    ...
    */
    'tiersMode': ProductDefaultPrice.TiersModeEnum;
    'transformQuantity': PriceTransformQuantity | null;
    /**
    * One of `one_time` or `recurring` depending on whether the price is for a one-time purchase or a recurring (subscription) purchase.
    */
    'type': ProductDefaultPrice.TypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ProductDefaultPrice.BillingSchemeEnum"
        },
        {
            "name": "created",
            "baseName": "created",
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "ProductDefaultPrice.ObjectEnum"
        },
        {
            "name": "product",
            "baseName": "product",
        ...
        },
        {
            ...
            "type": "ProductDefaultPrice.TaxBehaviorEnum"
        },
        {
            "name": "tiers",
            "baseName": "tiers",
        ...
        },
        {
            "name": "tiersMode",
            "baseName": "tiers_mode",
            "type": "ProductDefaultPrice.TiersModeEnum"
        },
        {
    ...
    static getAttributeTypeMap() {
        return ProductDefaultPrice.attributeTypeMap;
    }
}

export namespace ProductDefaultPrice {
