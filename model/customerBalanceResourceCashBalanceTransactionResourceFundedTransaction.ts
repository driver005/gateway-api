...
* 
*/
export class CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction {
    ...
    static getAttributeTypeMap() {
        return CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction.attributeTypeMap;
    }
}
