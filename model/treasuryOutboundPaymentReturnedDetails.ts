...
*/
export class TreasuryOutboundPaymentReturnedDetails {
    /**
    * Reason for the return.
    */
    'code': TreasuryOutboundPaymentReturnedDetails.CodeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "code",
            "baseName": "code",
            "type": "TreasuryOutboundPaymentReturnedDetails.CodeEnum"
        },
        {
            "name": "transaction",
    ...
    static getAttributeTypeMap() {
        return TreasuryOutboundPaymentReturnedDetails.attributeTypeMap;
    }
}

export namespace TreasuryOutboundPaymentReturnedDetails {
