...
export class IssuingCardShipping {
    ...
    */
    'carrier': IssuingCardShipping.CarrierEnum;
    ...
    */
    'service': IssuingCardShipping.ServiceEnum;
    /**
    * The delivery status of the card.
    */
    'status': IssuingCardShipping.StatusEnum;
    /**
    ...
    * Packaging options.
    */
    'type': IssuingCardShipping.TypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "carrier",
            "baseName": "carrier",
            "type": "IssuingCardShipping.CarrierEnum"
        },
        {
            "name": "customs",
            "baseName": "customs",
        ...
        },
        {
            "name": "service",
            "baseName": "service",
            "type": "IssuingCardShipping.ServiceEnum"
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "IssuingCardShipping.StatusEnum"
        },
        {
            "name": "trackingNumber",
    ...
    static getAttributeTypeMap() {
        return IssuingCardShipping.attributeTypeMap;
    }
}
