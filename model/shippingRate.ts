...
export class ShippingRate {
    ...
    */
    'object': ShippingRate.ObjectEnum;
    /**
    * Specifies whether the rate is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`.
    */
    'taxBehavior': ShippingRate.TaxBehaviorEnum;
    'taxCode': ShippingRateTaxCode | null;
    /**
    * The type of calculation to use on the shipping rate. Can only be `fixed_amount` for now.
    */
    'type': ShippingRate.TypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "object",
            "baseName": "object",
            "type": "ShippingRate.ObjectEnum"
        },
        {
            "name": "taxBehavior",
            "baseName": "tax_behavior",
            "type": "ShippingRate.TaxBehaviorEnum"
        },
        {
            "name": "taxCode",
            "baseName": "tax_code",
    ...
    static getAttributeTypeMap() {
        return ShippingRate.attributeTypeMap;
    }
}
